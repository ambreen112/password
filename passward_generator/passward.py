...
st.markdown(
    """
  <h1 style="text-align: center; color: blue; font-family: Arial, sans-serif; font-size: 40px; background-color: lightgreen; padding: 10px;">
...
if password:
    ...
    progress_colors = ["red", "orange", "yellow", "lightgreen", "green"]
